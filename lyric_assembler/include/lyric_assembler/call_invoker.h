#ifndef LYRIC_ASSEMBLER_CALL_INVOKER_H
#define LYRIC_ASSEMBLER_CALL_INVOKER_H
...
namespace lyric_assembler {
    ...
    class CallInvoker : public AbstractInvoker {
    ...
    public:
        CallInvoker();
        explicit CallInvoker(CallSymbol *call);
        CallInvoker(CallSymbol *call, ProcHandle *proc);
...
#endif // LYRIC_ASSEMBLER_CALL_INVOKER_H
