#ifndef LYRIC_PACKAGING_PACKAGE_WRITER_H
#define LYRIC_PACKAGING_PACKAGE_WRITER_H
...
namespace lyric_packaging {
    ...
    public:
         ...
         */
        template <typename T>
        tempo_utils::Status putPackageAttr(const tempo_utils::AttrSerde<T> &serde, const T &value)
        {
...
#endif // LYRIC_PACKAGING_PACKAGE_WRITER_H
