...
//
//tempo_utils::Status
//url_alloc(lyric_runtime::BytecodeInterpreter *interp, lyric_runtime::InterpreterState *state)
//{
...
//
//tempo_utils::Status
//url_ctor(lyric_runtime::BytecodeInterpreter *interp, lyric_runtime::InterpreterState *state)
//{
//    auto *currentCoro = state->currentCoro();
//
//    auto &frame = currentCoro->peekCall();
