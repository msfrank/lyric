#ifndef ZURI_CORE_URL_REF_H
#define ZURI_CORE_URL_REF_H
...
//tempo_utils::Status url_alloc(lyric_runtime::BytecodeInterpreter *interp, lyric_runtime::InterpreterState *state);
//tempo_utils::Status url_ctor(lyric_runtime::BytecodeInterpreter *interp, lyric_runtime::InterpreterState *state);
tempo_utils::Status url_equals(lyric_runtime::BytecodeInterpreter *interp, lyric_runtime::InterpreterState *state);

#endif // ZURI_CORE_URL_REF_H
