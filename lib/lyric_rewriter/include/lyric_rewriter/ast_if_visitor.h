#ifndef LYRIC_REWRITER_AST_IF_VISITOR_H
#define LYRIC_REWRITER_AST_IF_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstIfVisitor : public AstBaseVisitor {
    public:
        AstIfVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_IF_VISITOR_H
