#ifndef LYRIC_REWRITER_AST_MATCH_VISITOR_H
#define LYRIC_REWRITER_AST_MATCH_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstMatchVisitor : public AstBaseVisitor {
    public:
        AstMatchVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_MATCH_VISITOR_H
