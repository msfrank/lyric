#ifndef LYRIC_REWRITER_AST_DEFENUM_VISITOR_H
#define LYRIC_REWRITER_AST_DEFENUM_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstDefenumVisitor : public AstBaseVisitor {
    public:
        AstDefenumVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_DEFENUM_VISITOR_H