#ifndef LYRIC_REWRITER_AST_DEFCLASS_VISITOR_H
#define LYRIC_REWRITER_AST_DEFCLASS_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstDefclassVisitor : public AstBaseVisitor {
    public:
        AstDefclassVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_DEFCLASS_VISITOR_H
