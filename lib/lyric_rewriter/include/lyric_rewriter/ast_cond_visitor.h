#ifndef LYRIC_REWRITER_AST_COND_VISITOR_H
#define LYRIC_REWRITER_AST_COND_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstCondVisitor : public AstBaseVisitor {
    public:
        AstCondVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_COND_VISITOR_H
