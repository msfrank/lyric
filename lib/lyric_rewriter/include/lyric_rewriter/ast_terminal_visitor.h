#ifndef LYRIC_REWRITER_AST_TERMINAL_VISITOR_H
#define LYRIC_REWRITER_AST_TERMINAL_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstTerminalVisitor : public AstBaseVisitor {
    public:
        AstTerminalVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_TERMINAL_VISITOR_H
