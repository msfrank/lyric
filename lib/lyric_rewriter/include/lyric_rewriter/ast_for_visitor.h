#ifndef LYRIC_REWRITER_AST_FOR_VISITOR_H
#define LYRIC_REWRITER_AST_FOR_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstForVisitor : public AstBaseVisitor {
    public:
        AstForVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_FOR_VISITOR_H
