#ifndef LYRIC_REWRITER_AST_CATCH_VISITOR_H
#define LYRIC_REWRITER_AST_CATCH_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstCatchVisitor : public AstBaseVisitor {
    public:
        AstCatchVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_CATCH_VISITOR_H