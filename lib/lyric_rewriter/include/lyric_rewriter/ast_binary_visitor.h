#ifndef LYRIC_REWRITER_AST_BINARY_VISITOR_H
#define LYRIC_REWRITER_AST_BINARY_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstBinaryVisitor : public AstBaseVisitor {
    public:
        AstBinaryVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_BINARY_VISITOR_H
