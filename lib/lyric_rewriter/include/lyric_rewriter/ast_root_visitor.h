#ifndef LYRIC_REWRITER_AST_ROOT_VISITOR_H
#define LYRIC_REWRITER_AST_ROOT_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstRootVisitor : public AstBaseVisitor {
    public:
        AstRootVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_ROOT_VISITOR_H
