#ifndef LYRIC_REWRITER_AST_PARAM_VISITOR_H
#define LYRIC_REWRITER_AST_PARAM_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstParamVisitor : public AstBaseVisitor {
    public:
        AstParamVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_PARAM_VISITOR_H
