#ifndef LYRIC_REWRITER_AST_GLOBAL_VISITOR_H
#define LYRIC_REWRITER_AST_GLOBAL_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstGlobalVisitor : public AstBaseVisitor {
    public:
        AstGlobalVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_GLOBAL_VISITOR_H
