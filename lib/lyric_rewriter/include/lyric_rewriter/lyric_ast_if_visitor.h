#ifndef LYRIC_REWRITER_LYRIC_AST_IF_VISITOR_H
#define LYRIC_REWRITER_LYRIC_AST_IF_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class LyricAstIfVisitor : public LyricAstBaseVisitor {
    public:
        LyricAstIfVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_LYRIC_AST_IF_VISITOR_H
