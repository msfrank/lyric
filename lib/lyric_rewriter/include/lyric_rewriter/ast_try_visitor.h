#ifndef LYRIC_REWRITER_AST_TRY_VISITOR_H
#define LYRIC_REWRITER_AST_TRY_VISITOR_H
...
namespace lyric_rewriter {
    ...
    class AstTryVisitor : public AstBaseVisitor {
    public:
        AstTryVisitor(lyric_schema::LyricAstId astId, AbstractProcessorState *state);
...
#endif // LYRIC_REWRITER_AST_TRY_VISITOR_H