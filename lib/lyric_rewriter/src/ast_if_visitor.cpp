...
lyric_rewriter::AstIfVisitor::AstIfVisitor(
...
tempo_utils::Status
lyric_rewriter::AstIfVisitor::enter(lyric_parser::ArchetypeNode *node, VisitorContext &ctx)
{
...
tempo_utils::Status
lyric_rewriter::AstIfVisitor::exit(lyric_parser::ArchetypeNode *node, const VisitorContext &ctx)
{
