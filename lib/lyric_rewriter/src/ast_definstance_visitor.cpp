...
lyric_rewriter::AstDefinstanceVisitor::AstDefinstanceVisitor(
...
tempo_utils::Status
lyric_rewriter::AstDefinstanceVisitor::enter(lyric_parser::ArchetypeNode *node, VisitorContext &ctx)
{
        ...
        switch (childId) {
            ...
            default:
                return RewriterStatus::forCondition(RewriterCondition::kSyntaxError,
                    "unexpected definstance child node");
        }
    }
...
tempo_utils::Status
lyric_rewriter::AstDefinstanceVisitor::exit(lyric_parser::ArchetypeNode *node, const VisitorContext &ctx)
{
