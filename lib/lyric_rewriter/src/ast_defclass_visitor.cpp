...
lyric_rewriter::AstDefclassVisitor::AstDefclassVisitor(
...
tempo_utils::Status
lyric_rewriter::AstDefclassVisitor::enter(lyric_parser::ArchetypeNode *node, VisitorContext &ctx)
{
        ...
        switch (childId) {
            ...
            default:
                return RewriterStatus::forCondition(RewriterCondition::kSyntaxError,
                    "unexpected defclass child node");
        }
    }
...
tempo_utils::Status
lyric_rewriter::AstDefclassVisitor::exit(lyric_parser::ArchetypeNode *node, const VisitorContext &ctx)
{
