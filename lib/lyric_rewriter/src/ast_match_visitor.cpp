...
lyric_rewriter::AstMatchVisitor::AstMatchVisitor(
...
tempo_utils::Status
lyric_rewriter::AstMatchVisitor::enter(lyric_parser::ArchetypeNode *node, VisitorContext &ctx)
{
...
tempo_utils::Status
lyric_rewriter::AstMatchVisitor::exit(lyric_parser::ArchetypeNode *node, const VisitorContext &ctx)
{
