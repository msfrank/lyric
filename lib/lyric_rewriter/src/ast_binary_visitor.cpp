...
lyric_rewriter::AstBinaryVisitor::AstBinaryVisitor(
...
tempo_utils::Status
lyric_rewriter::AstBinaryVisitor::enter(lyric_parser::ArchetypeNode *node, VisitorContext &ctx)
{
...
tempo_utils::Status
lyric_rewriter::AstBinaryVisitor::exit(lyric_parser::ArchetypeNode *node, const VisitorContext &ctx)
{
