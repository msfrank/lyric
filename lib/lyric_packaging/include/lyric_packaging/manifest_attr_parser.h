#ifndef LYRIC_PACKAGING_MANIFEST_ATTR_PARSER_H
#define LYRIC_PACKAGING_MANIFEST_ATTR_PARSER_H
...
namespace lyric_packaging {
    ...
    class ManifestAttrParser : public tempo_utils::AbstractAttrParser {
    public:
...
#endif // LYRIC_PACKAGING_MANIFEST_ATTR_PARSER_H