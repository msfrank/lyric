#ifndef LYRIC_ASSEMBLER_INTERNAL_PLUGIN_MACRO_H
#define LYRIC_ASSEMBLER_INTERNAL_PLUGIN_MACRO_H

#include <lyric_rewriter/abstract_macro.h>

namespace lyric_assembler::internal {

    class PluginMacro : public lyric_rewriter::AbstractMacro {
    public:
        PluginMacro();
...
#endif // LYRIC_ASSEMBLER_INTERNAL_PLUGIN_MACRO_H
