#ifndef LYRIC_ASSEMBLER_INTERNAL_STORE_DATA_MACRO_H
#define LYRIC_ASSEMBLER_INTERNAL_STORE_DATA_MACRO_H

#include <lyric_rewriter/abstract_macro.h>

namespace lyric_assembler::internal {

    class StoreDataMacro : public lyric_rewriter::AbstractMacro {
    public:
        StoreDataMacro();
...
#endif // LYRIC_ASSEMBLER_INTERNAL_STORE_DATA_MACRO_H
