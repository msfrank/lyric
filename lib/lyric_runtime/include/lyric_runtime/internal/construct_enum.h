#ifndef LYRIC_RUNTIME_INTERNAL_CONSTRUCT_ENUM_H
#define LYRIC_RUNTIME_INTERNAL_CONSTRUCT_ENUM_H
...
namespace lyric_runtime::internal {
    ...
    tempo_utils::Status construct_enum(
        tu_uint32 address,
        tu_uint8 flags,
...
#endif // LYRIC_RUNTIME_INTERNAL_CONSTRUCT_ENUM_H