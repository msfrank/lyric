#ifndef LYRIC_ANALYZER_ROOT_ANALYZER_CONTEXT_H
#define LYRIC_ANALYZER_ROOT_ANALYZER_CONTEXT_H
...
namespace lyric_analyzer {
    ...
    class RootAnalyzerContext : public AbstractAnalyzerContext {
    public:
        RootAnalyzerContext(AnalyzerScanDriver *driver, lyric_assembler::ObjectRoot *root);
...
#endif // LYRIC_ANALYZER_ROOT_ANALYZER_CONTEXT_H
