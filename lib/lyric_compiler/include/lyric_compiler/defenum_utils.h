...
namespace lyric_compiler {
    ...
    tempo_utils::Result<lyric_assembler::CallSymbol *> declare_enum_default_init(
        lyric_assembler::EnumSymbol *enumSymbol,
        const std::string &allocatorTrap);

    tempo_utils::Status define_enum_default_init(
        const DefEnum *defenum,
        lyric_assembler::SymbolCache *symbolCache,
        lyric_typing::TypeSystem *typeSystem);

    tempo_utils::Result<Constructor> declare_enum_init(
        const lyric_parser::ArchetypeNode *node,
        lyric_assembler::EnumSymbol *enumSymbol,
        const std::string &allocatorTrap,
        lyric_typing::TypeSystem *typeSystem);

    tempo_utils::Result<Member> declare_enum_member(
        const lyric_parser::ArchetypeNode *node,
        bool isVariable,
        lyric_assembler::EnumSymbol *enumSymbol,
        lyric_typing::TypeSystem *typeSystem);

    tempo_utils::Result<Method> declare_enum_method(
        const lyric_parser::ArchetypeNode *node,
        lyric_assembler::EnumSymbol *enumSymbol,
        lyric_typing::TypeSystem *typeSystem);
    ...
    tempo_utils::Result<lyric_assembler::EnumSymbol *> declare_enum_case(
        const lyric_parser::ArchetypeNode *node,
        lyric_assembler::EnumSymbol *enumSymbol,
