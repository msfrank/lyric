...
namespace lyric_compiler {
    ...
    tempo_utils::Result<lyric_assembler::CallSymbol *> declare_class_default_init(
        lyric_assembler::ClassSymbol *classSymbol,
        const std::string &allocatorTrap);

    tempo_utils::Status define_class_default_init(
        const DefClass *defclass,
        const std::string &allocatorTrap,
        lyric_assembler::SymbolCache *symbolCache,
        lyric_typing::TypeSystem *typeSystem);

    tempo_utils::Result<Constructor> declare_class_init(
    ...
    tempo_utils::Result<Stub> declare_class_stub(
        const lyric_parser::ArchetypeNode *node,
        lyric_assembler::ClassSymbol *classSymbol,
        lyric_typing::TypeSystem *typeSystem);
