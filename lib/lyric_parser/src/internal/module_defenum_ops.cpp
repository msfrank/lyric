...
void
lyric_parser::internal::ModuleDefenumOps::enterEnumDecl(ModuleParser::EnumDeclContext *ctx)
{
    tempo_tracing::EnterScope scope("lyric_parser::internal::ModuleDefenumOps::enterEnumDecl");
}

void
lyric_parser::internal::ModuleDefenumOps::exitEnumDecl(ModuleParser::EnumDeclContext *ctx)
{
    tempo_tracing::ExitScope scope;
    ...
    // append decl node to defenum
    TU_RAISE_IF_NOT_OK (defenumNode->appendChild(declNode));
}
