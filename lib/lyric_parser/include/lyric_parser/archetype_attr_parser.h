...
namespace lyric_parser {
    ...
    class ArchetypeAttrParser : public tempo_utils::AbstractAttrParser {
    ...
    public:
        ...
        //bool attrMatchesKey(tu_uint32 index) const;

    private:
        std::shared_ptr<const internal::ArchetypeReader> m_reader;

        //tempo_utils::AttrResult<const lyi1::AttributeDescriptor *> getAttr(tu_uint32 index) const;
    };
}
