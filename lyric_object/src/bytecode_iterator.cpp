...
lyric_object::OpInfo ops[] = {
    ...
    { lyric_object::Opcode::OP_CALL_ACTION,    lyric_object::OpInfoType::FLAGS_U8_ADDRESS_U32_PLACEMENT_U16 },
    { lyric_object::Opcode::OP_CALL_EXTENSION, lyric_object::OpInfoType::FLAGS_U8_ADDRESS_U32_PLACEMENT_U16 },
